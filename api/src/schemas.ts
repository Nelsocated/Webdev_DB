...
export const pieBodySchema = z.object({
  name: z.string().min(2, "Name must at east be 2 characters."),
...
export const createPieSchema = z.object({ body: pieBodySchema });
...
export const authRequestSchema = z.object({ body: authBodySchema });
